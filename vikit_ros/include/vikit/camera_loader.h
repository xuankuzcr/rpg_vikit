...
bool loadFromRosNs(const std::string &ns, vk::AbstractCamera *&cam) {
  ...
  if (cam_model == "Ocam") {
    ...
    cam = new vk::PinholeCamera(
        ...
        getParam<double>(ns + "/scale", 1.0), getParam<double>(ns + "/cam_fx"),
        getParam<double>(ns + "/cam_fy"), getParam<double>(ns + "/cam_cx"),
        getParam<double>(ns + "/cam_cy"), getParam<double>(ns + "/cam_d0", 0.0),
    ...
    cam = new vk::EquidistantCamera(
        ...
        getParam<double>(ns + "/scale", 1.0), getParam<double>(ns + "/cam_fx"),
        getParam<double>(ns + "/cam_fy"), getParam<double>(ns + "/cam_cx"),
        getParam<double>(ns + "/cam_cy"), getParam<double>(ns + "/k1", 0.0),
        getParam<double>(ns + "/k2", 0.0), getParam<double>(ns + "/k3", 0.0),
    ...
    cam = new vk::PolynomialCamera(
        ...
        getParam<double>(ns + "/cam_skew"), getParam<double>(ns + "/k2", 0.0),
        getParam<double>(ns + "/k3", 0.0), getParam<double>(ns + "/k4", 0.0),
        getParam<double>(ns + "/k5", 0.0), getParam<double>(ns + "/k6", 0.0),
