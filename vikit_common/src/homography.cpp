...
void Homography::calcFromPlaneParams(const Vector3d &normal,
                                     const Vector3d &point_on_plane) {
  // Get Plane in second frame:
  Vector3d n_c1 = normal;
  double d = n_c1.dot(point_on_plane);
  H_c2_from_c1 = T_c2_from_c1.rotationMatrix() +
