...
ForwardCompositionalSE3::ForwardCompositionalSE3(
    ...
    SE3<double> &init_model, int n_levels, int n_iter, float res_thresh,
    bool display, Method method, int test_id)
    : cam_pyr_(cam_pyr), depth_pyr_(depth_pyr), img_pyr_(img_pyr),
      tpl_pyr_(tpl_pyr), img_pyr_dx_(img_pyr_dx), img_pyr_dy_(img_pyr_dy),
      n_levels_(n_levels), display_(display), log_(test_id < 0),
...
void ForwardCompositionalSE3::runOptimization(SE3<double> &model,
                                              int levelBegin, int levelEnd) {
...
double ForwardCompositionalSE3::computeResiduals(const SE3<double> &model,
...
SecondOrderMinimisationSE3::SecondOrderMinimisationSE3(
    ...
    : cam_pyr_(cam_pyr), depth_pyr_(depth_pyr), img_pyr_(img_pyr),
      tpl_pyr_(tpl_pyr), img_pyr_dx_(img_pyr_dx), img_pyr_dy_(img_pyr_dy),
      tpl_pyr_dx_(tpl_pyr_dx), tpl_pyr_dy_(tpl_pyr_dy), level_(n_levels - 1),
...
double SecondOrderMinimisationSE3::computeResiduals(const SE3<double> &model,
                                                    bool linearize_system,
                                                    bool compute_weight_scale) {
  // Warp the image such that it aligns with the template image
  double chi2 = 0;
