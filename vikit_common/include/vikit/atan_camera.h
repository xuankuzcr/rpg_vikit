 ...
 *
 *  The code is an implementation of the ATAN class in PTAM by Georg Klein using
 * Eigen.
 */
...
public:
  ATANCamera(double width, double height, double fx, double fy, double dx,
             double dy, double s);
  ...
  virtual double errorMultiplier2() const { return fx_; }

  virtual double errorMultiplier() const { return 4 * fx_ * fy_; }
