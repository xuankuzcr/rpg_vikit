...
void testAccuracy(vk::AbstractCamera *cam) {
  ...
  cout << "Reprojection error = " << error << " (took " << t.stop() * 1000
       << "ms)" << endl;
}

int main(int argc, char **argv) {
  vk::AbstractCamera *cam_pinhole = new vk::PinholeCamera(
      640, 480, 323.725240539365, 323.53310403533, 336.407165453746,
      235.018271952295, -0.258617082313663, 0.0623042373522829,
      0.000445967802619555, -0.000269839440982019);

  vk::AbstractCamera *cam_atan = new vk::ATANCamera(
      752, 480, 0.511496, 0.802603, 0.530199, 0.496011, 0.934092);
